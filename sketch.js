...
function setup() {
  ...
  bob1= new Bodies.circle(340,450,40,bob_options)
  World.add(world,bob1)

  bob2= new Bodies.circle(350,450,40,bob_options)
  World.add(world,bob2)

  bob3= new Bodies.circle(360,450,40,bob_options)
  World.add(world,bob3)

  bob4= new Bodies.circle(370,450,40,bob_options)
  World.add(world,bob4)

  bob5= new Bodies.circle(380,450,40,bob_options)
